...
<body>
    <div class="container mt-5">
        ...
        <form method="POST" action="/practicas/M07---Desenvolupament-web-en-entorn-servidor/public/index.php?action=create">
            ...
            <a href="/practicas/M07---Desenvolupament-web-en-entorn-servidor/public/index.php" class="btn btn-secondary">Tornar al
                menú</a>
        </form>
    </div>
</body>
